package org.andrewtorson.wordcloud.aws
...
import org.andrewtorson.amazonapi.SignedAWSRequestsHelper
import org.andrewtorson.wordcloud.component.AsyncProductDescriptionFinder


/**
 * Created by Andrew Torson on 11/29/16.
 */
object DefaultProductDescriptionFinder extends AsyncProductDescriptionFinder{
  ...
  override def extract(urlEncoded: String): Try[ProductLocator] =
   try {
    ...
    val encodedURL = getHelper (host).sign (ListMap[String, String] (
